...
namespace Luma.MvvmCross.NavigationDrawer
{
    ...
    {
        public EventBasedSherlockActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes)
